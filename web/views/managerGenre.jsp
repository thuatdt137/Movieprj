...
<html lang="en">
    <head>
        ...
        <script>
            ...
            function pageLink(index) {
                ...
                var url = "managegenre?page=" + encodeURIComponent(inputValue) + "&index=" + index;
            ...
            <div class="table-wrapper">
                ...
                <div class="genre-table">
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <c:forEach items="${listA}" var="genre">
                                <tr>
                                    <td>
                                        <span class="custom-checkbox">
                                            <input type="checkbox" id="checkbox${genre.id}" class="Rowchecked" name="options[]" value="${genre.id}">
                            ...
                            <c:forEach begin="1" end="${endPage1}" var ="i">
                                <c:choose>
                                    <c:when test="${currPage eq i}">
                                        <li id="${i}" class="page-item page-user active"><a href="managegenre?index=${i}" class="page-link">${i}</a></li>
                                        </c:when>
                                        <c:otherwise>
                                        <li id="${i}" class="page-item page-user"><a href="managegenre?index=${i}" class="page-link">${i}</a></li>
                                        </c:otherwise>
                                    </c:choose>
                                </c:forEach>
                        </ul>
    ...
    <!-- Add Modal HTML -->
    <div id="addGenreModall" class="modal fade">
